...
<div class="sidebar">
  ...
  <div class="navbutton">
	...
	<a class="HomePage" >Profile Settings</a>
...
<form method="post" action="updateUserDetails.php" name="send" onSubmit="return check()">
	...
	<table>
	<tr>
	<td> First Name: </td><td>  <input type = "text" name = "firstname" id = "firstname" value= "<?php echo $info["UserFirstName"];?>"/> </td>
	</tr>
	
	<tr>
	<td> Last Name: </td><td><input type = "text" name = "lastname" id = "lastname" value= "<?php echo $info["UserLastName"];?>"/>  </td>
	</tr>
	
	<tr>
	<td> Change Password: </td><td><input type = "password"  id="password" name ="password" placeholder = "*****"/> </td>
	</tr>
	
	<tr>
	<td> Confirm Password: </td><td> <input type = "password" id="confirmpassword" name="confirmpassword"  placeholder = "*****"/> </td>
	</tr>
	
	<tr>
	<td> Street 1: </td><td><input type = "text" name = "street1" id="street1" value= "<?php echo $info["UserStreet1"];?>"/> </td>
	</tr>
	
	<tr>
	<td> Street 2: </td><td><input type = "text" name = "street2" id="street2" value= "<?php echo $info["UserStreet2"];?>"/></td>
	</tr>
	
	<tr>
	<td> City: </td><td><input type = "text" name = "city" id="city" value= "<?php echo $info["UserCity"];?>"/> </td>
	</tr>
	...
	<tr>
	<td> Zip: </td><td><input type = "text" name = "zip" id="zip" value= "<?php echo $info["UserZip"];?>"/> </td>
	</tr>
	
	<tr>
	<td> Email: </td><td><input type = "text" name = "email" id="email" value= "<?php echo $info["UserEmail"];?>"/> </td>
	</tr>
	
	<tr>
	<td> Home Phone: </td><td> <input type = "text" name = "homephone" value= "<?php echo $info["UserPhone"];?>"/></td>
	</tr>
	
	<tr>
	<td> Cell Phone: </td><td><input type = "text" name = "cellphone" value= "<?php echo $info["UserCell"];?>"/> </td>
	</tr>
	
	<tr>
	<td> Fax: </td><td><input type = "text" name = "fax" value= "<?php echo $info["UserFax"];?>"/> </td>
	</tr>
	
	<tr>
	<td> Home Page: </td><td><input type = "text" name = "homepage" value= "<?php echo $info["UserHomePage"];?>"/> </td>
	</tr>
	
	
	
	<tr>
	<td> <b>Old password: </b></td><td><input type ="password" name="oldpassword" value= "" placeholder = "*****"/> </td>
	</tr>
	...
	<input class="button" type="submit" value="confirm changes" name="submitBtn" id="button" ><br><br></div><hr>
