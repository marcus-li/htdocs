...
<head>
<meta charset="utf-8">
<title>Poster's Register</title>
<script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/1.2.6/jquery.min.js"></script>
<meta name="keywords" content="register for poster">
...
elseif(usr.length < 2)
	...
	$("#CompanyId").removeClass('object_ok'); // if necessary
	$("#CompanyId").addClass("object_error");
	$("#status").html('<center><font color="red">The CompanyID should have <strong>6</strong> characters.</font></center>');
	}
...
{
?>
<h1>Uconn's Job Search Register - For Poster</h1>
<div class="frame">
