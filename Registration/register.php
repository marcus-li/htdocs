...
<form method="post" action="<?php $_PHP_SELF ?>" name="send" onSubmit="return Check()">
  ...
  <br>
  <input type="tel" name="UserCell" size="20" class="c3a" placeholder="(xxx)xxx-xxxx">
  <a>(Optional)</a> <br>
  Address：<br>
  <input type="text" name="UserAddress1" size="20" class="c3a" placeholder="address line 1">
  <br>
  <input type="text" name="UserAddress2" size="20" class="c3a" placeholder="address line 2">
  <a>(Optional)</a> <br>
  City：<br>
  ...
  <b id="Login"><a href="http://localhost/Login/index.php">Already registered? Login</a></b>
</form>
